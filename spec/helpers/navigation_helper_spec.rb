...
RSpec.describe NavigationHelper, :type => :helper do
  ...
  context 'non-signed in user' do
    ...
    context '#collapsible_links_partial_path' do
      it "returns signed_out_links partial's path" do
        expect(helper.collapsible_links_partial_path).to(eq 'layouts/navigation/collapsible_elements/signed_out_links')
      end
    end
  end
end